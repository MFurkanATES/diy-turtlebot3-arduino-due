...
#define FREQUENCY_ODOMETRY 				    100 		// [ms] default 250ms
#define FREQUENCY_ROSPINONCE 				100 		// [ms]
#define FREQUENCY_CONTROLLER 				20 			// [ms] default 50ms

/* Rate computing parameters */
#define RATE_DIRECTION_MEDIAN_FILTER_SIZE 	3
#define RATE_CONV 							0.001693129  	// [inc] -> [rad]
...
#define RATE_CONTROLLER_KD 					100000000000.0  //4500000000000
                                                    //300000000000
#define RATE_CONTROLLER_KI 					0.00005 	    //0.00001
#define RATE_INTEGRAL_FREEZE				500
...
#define BASE_LENGTH 						0.3 		// [m]  0.288
